...
namespace Desktop_app
{
    public partial class Human_Resources : Form
    {
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            List<Shift> shifts = hr.Repository.GetShiftsByEmpId(Convert.ToInt32(listView1.SelectedItems[0].Tag));
            label42.Text = listView1.SelectedItems[0].Tag.ToString();
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            newShift.EmpId = Convert.ToInt32(listView1.SelectedItems[0].Tag);
            newShift.Type = comboBox2.SelectedIndex;
            newShift.Date = dateTimePicker1.Value.ToString("yyyy-MM-dd");
            if (hr.Repository.AddShift(newShift))
            {
                MessageBox.Show("OK");
            }
            else
        ...
        private void populateshifttypes()
        {
            comboBox2.DisplayMember = "Key";
            comboBox2.ValueMember = "Value";
            comboBox2.Items.Add(new KeyValuePair<string, int>("Day", 0));
            comboBox2.Items.Add(new KeyValuePair<string, int>("Afternoon", 1));
            comboBox2.Items.Add(new KeyValuePair<string, int>("Night", 2));
        }
    }
}