...
namespace Desktop_app
{
    public class ArtanPanel : Panel
    {
        ...
        private Color gradientTopColor = Color.LightGray;
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            LinearGradientBrush brushArton = new LinearGradientBrush(this.ClientRectangle, this.GradientTopColor, this.gradientBottomColor, this.gradientAngle); ;
            Graphics graphicsArtan = e.Graphics;
            graphicsArtan.FillRectangle(brushArton, ClientRectangle);
